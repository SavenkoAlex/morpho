...
{
#ifdef _ANDROID_USB
		struct libusb_device		*m_px_device;
#else
		struct libusb_device   *m_px_device;
#endif
...
#ifdef _ANDROID_USB
/////////////////////////////////////////////////////////////////////
typedef I (F_MSO_COM_OPEN_FD) (
	MORPHO_HANDLE						*o_ph_Mso100Handle,
	T_MORPHO_CALLBACK_COM_OPEN_FD		i_pf_CallbackComOpen,
	T_MORPHO_CALLBACK_COM_SEND			i_pf_CallbackComSend,
	T_MORPHO_CALLBACK_COM_RECEIVE		i_pf_CallbackComReceive,
	T_MORPHO_CALLBACK_COM_RECEIVE_FREE	i_pf_CallbackComReceiveFree,
	T_MORPHO_CALLBACK_COM_CLOSE			i_pf_CallbackComClose,
...
typedef F_MSO_COM_OPEN_FD *PF_MSO_COM_OPEN_FD;


MSO100_API
F_MSO_COM_OPEN_FD MSO_ComOpenFD;
#endif //_ANDROID_USB
