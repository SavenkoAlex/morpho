...
#endif
{
	...
	UC          m_uc_DefautSubVersion;
	UC          m_uc_DefautAlgoType;
	/* FFD settings version. */
	UC          m_uc_ffd_settings_version;
	UC          m_uc_sdk_sensorfab_version;
	UC          m_uc_sdk_sensorfab_params_version;
	/* */
	UC			m_auc_ExtraInfo[16];
}T_HARDWARE_INFO_V5, *PT_HARDWARE_INFO_V5;

typedef T_HARDWARE_INFO_V5 T_HARDWARE_INFO;
typedef PT_HARDWARE_INFO_V5 PT_HARDWARE_INFO;

#define T_HARDWARE_INFO_VERSION 5
